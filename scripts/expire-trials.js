...
/**
 * Trial Expiration Cron Job (JavaScript version for Railway)
 * 
 * This script runs daily to expire trial accounts that have exceeded their 7-day limit.
 * 
 * Usage:
 * - Railway Cron: 0 22 * * * node scripts/expire-trials.js
 * - Local testing: node scripts/expire-trials.js
 */
...
module.exports = { expireTrials, getTrialStats }