  ...
  if (!agentEnabled) {
    return (
      <div className="relative mb-4">
        ...
        <div className="bg-[#2d2d2d] border border-[#363636] rounded-xl rounded-b-none relative overflow-hidden">
          <div className="p-4">
            <div className="flex items-center gap-3 mb-3">
              <div className="w-8 h-8 rounded-full bg-[#363636] flex items-center justify-center">
                <div className="text-[#666] text-sm">🤖</div>
              </div>
              <div>
  ...
  return (
    <>
      <div className="relative mb-4">
        ...
        <div 
          className="bg-[#2d2d2d] border border-[#363636] rounded-xl rounded-b-none relative overflow-hidden cursor-pointer hover:bg-[#333333] transition-colors group"
