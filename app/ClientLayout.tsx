      ...
      <body>
        <div className="relative flex size-full min-h-screen flex-col bg-[#1a1a1a] dark group/design-root overflow-x-hidden" style={{fontFamily: '"Space Grotesk", "Noto Sans", sans-serif'}}>
          <div className="layout-container flex h-full grow flex-col">
            ...
            <header className={`${isModalOpen ? 'hidden' : 'fixed'} top-0 left-0 right-0 w-full z-[1000] flex items-center justify-between whitespace-nowrap border-b border-solid border-b-[#363636] px-10 py-3 bg-[#1a1a1a]`}>
              ...
              <div className="flex max-w-[960px] flex-1 flex-col">
                <div className="pb-3">
                  <div className="flex border-b border-[#4d4d4d] px-4 gap-8 justify-center">
                    ...
                    <a className="flex flex-col items-center justify-center border-b-[3px] border-b-transparent text-[#adadad] gap-1 pb-[7px] pt-2.5" href="/settings">
                      <div className="text-[#adadad]" data-icon="Gear" data-size="24px" data-weight="regular">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" fill="currentColor" viewBox="0 0 256 256">
                          <path
                      ...
                      <p className="text-[#adadad] text-sm font-bold leading-normal tracking-[0.015em]">Settings</p>
                    </a>
                  </div>
                </div>
              </div>
