...
export default function NoGpsLocationModal({ 
  ...
  // Debounced search to get suggestions without auto-selecting
        ...
        service.getPlacePredictions(
          ...
          (predictions, status) => {
            ...
            if (predictions && predictions.length > 0) {
              console.log('[SEARCH] ✅ Found predictions:', predictions.length)
      ...
      if (window.google && window.google.maps) {
        ...
        try {
          ...
          google.maps.event.addListenerOnce(googleMap, 'idle', () => {
            ...
            // No longer using Google Autocomplete - we have custom dropdown now
            console.log('[MAP] ✅ Custom search initialized')
  ...
  const handleSuggestionSelect = (prediction: google.maps.places.AutocompletePrediction) => {
    ...
    console.log('[SEARCH] 🎯 Selected suggestion:', prediction.description)
            ...
            {!isLoading && !error && (
              <>
                        ...
                        <div
                          ...
                          className={`px-4 py-3 cursor-pointer transition-colors border-b border-[#363636] last:border-b-0 ${
                            index === selectedSuggestionIndex 
                              ...
                              : 'text-[#adadad] hover:bg-[#363636] hover:text-white'
                          }`}
                        ...
                        >
                          <div className="flex items-center gap-3">
                            ...
                            <div className="flex-1 min-w-0">
                              ...
                              <div className="text-xs opacity-70 truncate">{suggestion.structured_formatting.secondary_text}</div>
                            </div>
                          </div>
                        </div>
                      ))}
                ...
                <div className="text-[#adadad] text-xs text-center font-medium">
                  ↑↓ Navigate suggestions • Enter to select • Escape to close • Drag marker to fine-tune
                </div>
